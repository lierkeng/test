...
public class UtilsMapDistance {
    ...
    private UtilsMapDistance(){}
    private static UtilsMapDistance instance;

    public static synchronized UtilsMapDistance getInstance(){
        if(instance == null){
            instance = new UtilsMapDistance();
        }
        return instance;
    }
    /**
